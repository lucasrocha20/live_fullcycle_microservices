...
import PaymentApproved from "../../domain/entities/event/PaymentApproved";
...
export default class ProcessPayment {
    ...
    async execute (input: Input): Promise<void> {
        ...
        const transaction = Transaction.create(input.ticketId, input.eventId, output.tip, input.price, output.status);
